...
namespace Football.DataAccess.Migrations
{
    ...
    [Migration("20170929100121_addCompetitionLogo")]
    partial class addCompetitionLogo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Models.GlobalMedia", b =>
                {
            ...
            modelBuilder.Entity("DataAccess.Models.Calendario", b =>
                {
                    b.HasOne("DataAccess.Models.Partido", "Match")
                        .WithMany()
            ...
            modelBuilder.Entity("DataAccess.Models.Competicion", b =>
                {
                    b.HasOne("DataAccess.Models.GlobalMedia", "CompetitionLogo")
                        .WithMany()
            ...
            modelBuilder.Entity("DataAccess.Models.EquiposParticipan", b =>
                {
                    b.HasOne("DataAccess.Models.Competicion", "Competicion")
                        .WithMany()
                        .HasForeignKey("CodCompeticion")
            ...
            modelBuilder.Entity("DataAccess.Models.Estadio", b =>
                {
                    b.HasOne("DataAccess.Models.GlobalMedia", "Picture")
                        .WithMany()
