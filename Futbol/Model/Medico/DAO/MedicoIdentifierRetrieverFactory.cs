...
namespace Futbol.Model.Medico.DAO
{
    ...
    /// </summary>
   class MedicoIdentifierRetrieverFactory
    {
        private const String RETRIEVER_CLASS_NAME_PARAMETER =
            "MedicoIdentifierRetrieverFactory/retrieverClassName";

        private MedicoIdentifierRetrieverFactory() { }

       internal IMedicoIdentifierRetriever IMedicoIdentifierRetriever
       {
           get
           {
        ...
        public static IMedicoIdentifierRetriever GetRetriever() {
            ...
            return (IMedicoIdentifierRetriever)theObject;
