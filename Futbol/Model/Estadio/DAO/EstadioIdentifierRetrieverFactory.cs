...
namespace Futbol.Model.Estadio.DAO
{
    ...
    /// </summary>
   class EstadioIdentifierRetrieverFactory
    {
        private const String RETRIEVER_CLASS_NAME_PARAMETER =
            "EstadioIdentifierRetrieverFactory/retrieverClassName";

        private EstadioIdentifierRetrieverFactory() { }

       internal IEstadioIdentifierRetriever IEstadioIdentifierRetriever
       {
           get
           {
        ...
        public static IEstadioIdentifierRetriever GetRetriever() {
            ...
            return (IEstadioIdentifierRetriever)theObject;
