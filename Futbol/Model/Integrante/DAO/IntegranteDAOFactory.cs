...
namespace Futbol.Model.Integrante.DAO
{
    ...
    public sealed class IntegranteDAOFactory
    {
        ...
        public static IntegranteDAO GetDAO() {
            ...
            try {
                ...
                return (IntegranteDAO)theObject;
