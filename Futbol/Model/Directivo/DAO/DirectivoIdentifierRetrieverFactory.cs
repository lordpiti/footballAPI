...
namespace Futbol.Model.Directivo.DAO
{
    ...
    /// </summary>
   class DirectivoIdentifierRetrieverFactory
    {
        private const String RETRIEVER_CLASS_NAME_PARAMETER =
            "DirectivoIdentifierRetrieverFactory/retrieverClassName";

        private DirectivoIdentifierRetrieverFactory() { }

       internal IDirectivoIdentifierRetriever IDirectivoIdentifierRetriever
       {
           get
           {
        ...
        public static IDirectivoIdentifierRetriever GetRetriever() {
            ...
            return (IDirectivoIdentifierRetriever)theObject;
