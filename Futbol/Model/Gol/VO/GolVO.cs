...
namespace Futbol.Model.Gol.VO
{
    public class GolVO
    {
        ...
        public GolVO(int cd_Partido, int cd_Jugador, int minuto, String tipo, String video)
        {
            this.cd_Partido = cd_Partido;
            this.cd_Jugador = cd_Jugador;
            this.minuto = minuto;
        ...
        public GolVO(int cd_Jugador, int minuto, String tipo)
        {          
            this.cd_Jugador = cd_Jugador;
            this.minuto = minuto;
            this.tipo = tipo;
        ...
        public GolVO(int cd_Jugador, int minuto, String tipo, String video)
        {
            this.cd_Jugador = cd_Jugador;
            this.minuto = minuto;
            this.tipo = tipo;
