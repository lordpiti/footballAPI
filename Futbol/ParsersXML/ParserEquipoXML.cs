...
{
    public class ParserEquipoXML
    {
        private static bool isValid = true; 
        public static EquipoTotalCO parseEquipoXML(String rutaFichero)
        {
                        ...
                        switch (xmlReader.Name)
                        {
                            case "datosEquipo":
                                ...
                                while (xmlReader.MoveToNextAttribute())
                                {
                                    switch (xmlReader.Name)
                                    {
                                        ...
                                        case "fotoEscudo":
                                            fotoEscudo = xmlReader.Value;
                                            break;
                                        case "fotoPlantilla":
                                            fotoPlantilla = xmlReader.Value;
                                            break;
                                        default:
                                            break;
                                ...
                                equipo = new EquipoVO(nombre, ciudad, cod_Estadio,fotoEscudo,fotoPlantilla);
                            ...
                            case "estadio":
                                ...
                                while (xmlReader.MoveToNextAttribute())
                                {
                                    ...
                                    {
                                        case "nombre":
                                            nombreEstadio= xmlReader.Value;
                                            break;
                                        case "capacidad":
                                            capacidad = Int32.Parse(xmlReader.Value);
                                            break;
                                        case "direccion":
                                            direccion = xmlReader.Value;
                                            break;
                                        case "tipo":
                                ...
                                estadio = new EstadioVO(nombreEstadio, capacidad, direccion, tipo, foto);
                                break;
